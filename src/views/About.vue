<template>
  <div class="about">
    <div class="mb-4">
      <div class="card pa-5 mb-2 card_primary">
        <h2 class="white--text">About Us</h2>
        <p id="intro" class="mt-2 white--text">
          TrapScan is a mobile web application designed by conservation
          volunteers to simplify their record keeping and reporting workload.
        </p>
      </div>
      <v-expansion-panels multiple flat class="my-6">
        <CollapseableSection title="Commitment to Volunteers">
          ...
          <br /><br />We want to minimise the time it takes to record data to free up more
          ...
          from each other and make better decisions we can make as a nation.
          <br /><br />We want everyone to be able to see these results though, not just the
          ...
          engaging if the volunteers can track their efforts and view progress
          without having to wrestle with spreadsheets and file management.
        </CollapseableSection>
        <CollapseableSection :end="true" title="Commitment to Project Coordinators">
          ...
          tooling to make their life easier.
          <br /><br />In future plan to build in volunteer relationship and asset management
          features, and to improve the project onboarding and offboarding
          experiences for both parties.
          <br /><br />We believe that volunteer project coordinators are modern day heroes
          ...
          catering directly to them, so if you are a project coordinator and
          have some ideas, please reach out :)
        </CollapseableSection>
      </v-expansion-panels>
      <div class="card pa-5 my-5 red">
        <h2 class="white--text mb-1">Public Beta</h2>

        <p class="blurb white--text">
      ...
      <v-expansion-panels multiple flat class="my-6">
        <CollapseableSection
          title="The significance of our wildlife and the problem of mammalian pests"
        >
          Aotearoa New Zealand was isolated for 80 million years and was the
          ...
          internationally significant and important to protect.
          <br /><br />The introduction of mammalian pests with the arrival of humans led to
          the extinction of over 65 of our most treasured species and to this
          day we are still losing the battle…
        </CollapseableSection>
        <CollapseableSection title="Upcoming features">
          <ul>
            <li>My history - see your previous scans, and can edit them</li>
            <li>Default baits - uses what you've set per trap type instead of asking you every time</li>
            <li>Trapline check-in - time your run and bulk update any traps you didn’t scan</li>
            <li>Leaderboards - see by person, by trap, by project and globally</li>
            <li>Nearby Projects - like Nearby Traps but for top 5 closest projects to join</li>
          </ul>
        </CollapseableSection>
        <CollapseableSection :end="true" title="Fight for the Wild documentary">
          Every year an army of introduced predators devours the eggs and chicks
          of some 26 million native New Zealand birds, as well as countless
          insects, amphibians, reptiles and plants. We currently have more than
          4000 natives on the threatened species list and many more vulnerable
          to predation – New Zealand’s catalogue of shame.
          <br />But in 2016,
          the nation decided enough was enough. Predator Free 2050 was born — an
          ...
          visions, hard won victories and hope.
          <br /><br />Fight for the Wild is a
          ...
          a wilderness saved and our Wild returned.
          <a
            id="documentary-link"
            href="https://www.rnz.co.nz/programmes/fight-for-the-wild"
          >Fight for the Wild documentary</a>
        </CollapseableSection>
      </v-expansion-panels>
    </div>
  </div>
...
<script>
import CollapseableSection from '../components/about/CollapseableSection.vue'
export default {
  components: {
    CollapseableSection
  }
